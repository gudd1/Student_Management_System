...
class Students(models.Model):
    ...
    updated_at = models.DateTimeField(auto_now=True)
    objects = models.Manager()
    report_card=models.FileField(null=True)
...
def create_user_profile(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        if instance.user_type == 3:
            Students.objects.create(admin=instance, course_id=Courses.objects.get(id=3),
                                    session_year_id=SessionYearModel.objects.get(id=1), address="", profile_pic="",
                                    gender="")
        '''if instance.user_type == 3:
            Students.objects.create(admin=instance,address="", profile_pic="",
                                    gender="")'''
