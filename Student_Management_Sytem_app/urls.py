...
path('otp_varifiction/',views.otp_varification,name='otp_varification'),
path('verify_otp/<key>',views.verify_otp,name='verify_otp'),
path('new_password/',views.new_password,name='new_password'),
path('save_password/<Email>',views.save_password,name='save_password'),
...
path('session_examtype/',StaffViews.session_examtype,name="session_examtype"),
path('course_list/',StaffViews.course_list,name="course_list"),
path('staff_list/',StaffViews.staff_list,name="staff_list"),
path('class_list/',StaffViews.class_list,name="class_list"),
path('student_list/<id>',StaffViews.student_list,name="student_list"),
path('student_report_card/<student_id>',StaffViews.student_report_card,name="student_report_card"),
path('check_passwords/',HodViews.check_passwords,name="check_passwords"),
path('save_report/',StaffViews.save_report,name="save_report"),
path('save_report_card/',StaffViews.save_report_card,name="save_report_card"),
path('take_input/',StaffViews.take_input,name="take_input"),
path('check_ifsaved/',StaffViews.check_ifsaved,name="check_ifsaved"),
path('delete_report/',StaffViews.delete_report,name="delete_report"),
path('edit_report/',StaffViews.edit_report,name="edit_report"),
path('edit_report_card/<student_id>',StaffViews.edit_report_card,name="edit_report_card"),
path('view_result/',StudentViews.view_result,name="view_result"),
path('annual_result/',StudentViews.annual_result,name="annual_result"),
path('see_report_card/',StudentViews.see_report_card,name="see_report_card"),

#path('report_card/',StaffViews.report_card,name="report_card"),
]
